<template>
  <div>
    <group class='top'>
      <x-input type="number"  :is-type="valid_amont" text-align="center" placeholder-align="center" placeholder="输入金额  元" v-model="amount">
    ...
    export default {
      ...
      methods:{
        ...
        pay_1:function () {
          this.show_pay = false
          var that = this
          var url = this.common.SERVER_URL  + "api/mp/recharge/order?amount="+ this.amount +"&openid="+this.wxinfo.user.openId+"&unionid="
