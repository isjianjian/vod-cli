<template>
  <div>
    ...
    <scroller :pullup-config="upconfig" :pulldown-config="downconfig" @on-pulldown-loading="reload"
              @on-pullup-loading="add" :use-pulldown="true" :use-pullup="true" ref="scroller" height="-43" lock-x
            ...
            <div class="weui-cell">
              ...
              <div class="weui-cell__bd">
                <div class="weui-flex bd_title">
                  ...
                  <div style='color:#D3D3D3' v-if="new Date(item.timeExpire) < nowDate && item.status == 1"
                       class="weui-flex__item right">
                    已失效
                  </div>
                </div>
